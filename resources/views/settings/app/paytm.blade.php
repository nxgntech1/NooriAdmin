        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs card-header-tabs align-items-end">
               ...
               <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active paytm_active_label" href="{!! url('settings/payment/paytm') !!}"><i class="fa fa-envelope-o mr-2"></i>{{trans('lang.app_setting_paytm')}}<span class="badge ml-2"></span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="card-body">
                ...
                <div class="row restaurant_payout_create">
                    <div class="restaurant_payout_create-inner">
                        <fieldset>
                            ...
                            @foreach($paytm as $data)

                                <div class="form-check width-100">
                                <input type="hidden" class="id" id="id"  value="{{$data->id}}">

                                    <input type="checkbox" class=" enable_paytm" id="enable_paytm" value="{{$data->isEnabled}}" @if($data->isEnabled == 'true') checked=checked @endif>
                                    <label class="col-3 control-label" for="enable_paytm">{{trans('lang.app_setting_enable_paytm')}}</label>
                                </div>  
                                 <div class="form-check width-100">
                                    <input type="checkbox" class=" enable_paytm_sendbox" id="enable_paytm_sendbox" value="{{$data->isSandboxEnabled}}" @if($data->isSandboxEnabled == 'true') checked=checked @endif>
                                    <label class="col-3 control-label" for="enable_paytm_sendbox">{{trans('lang.app_setting_enable_sandbox_mode_paytm')}}</label>
                                </div> 
                                <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.paytm_merchant_key')}}</label>
                                <div class="col-7">
                                    <input type="password" class="form-control paytm_merchant_key" value="{{ $data->merchant_key }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row width-100">
                                ...
                                <div class="col-7">
                                    <input type="password" class="form-control paytm_id" value="{{ $data->merchant_Id }}">
                                </div>
                            </div>
                ...
                <div class="form-group col-12 text-center btm-btn">
                    <button type="button" class="btn btn-primary save_paytm_btn" ><i class="fa fa-save"></i> {{trans('lang.save')}}</button>
...
@section('scripts')
 ...
 <script>
  ...
  $(".save_paytm_btn").click(function(){
    ...
    var id =$('.id').val();
        var url = "{{ route('payment.paytmUpdate',':id') }}";
