    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-5 align-self-center">
                ...
                <h3 class="text-themecolor">{{trans('lang.canceland_reject_orders')}}</h3>
            ...
            <div class="col-md-7 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{trans('lang.canceland_reject_orders')}}</li>
                            ...
                            <!-- <div class="userlist-top-left">
                                ...
                                <div id="users-table_filter" class="ml-auto">
                                    <div class="form-group mb-0">
                                        <form action="{{ route('parcel.rejected') }}" method="get">
                                            ...
                                            <div class="search-box position-relative">
                                                ...
                                                <a class="btn btn-warning btn-flat" href="{{url('parcel/rejected')}}">Clear</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                          ...
                                          {{-- <td class="address-td">{{ $ride->depart_name}}</td>
                                            ...
                                            <td class="dt-time"><span class="date">{{ date('d F Y',strtotime($ride->created_at))}}</span>
                                                <span class="time">{{ date('h:i A',strtotime($ride->created_at))}}</span></td>
                                            <td class="action-btn">
