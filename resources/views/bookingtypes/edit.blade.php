  ...
  <div class="row">
	...
	<div class="card-body">
		...
		<div class="error_top"></div>
			...
			@endif
		<form action="{{ route('bookingtypes.update',$bookingtypes->id) }}" method="post"  enctype="multipart/form-data">
		@csrf
        @method("PUT")
          	...
          	<div class="restaurant_payout_create-inner">
          		<fieldset>
                      ...
                      <div class="form-group row width-50">
							...
							<div class="col-7">
								<input type="text" class="form-control car_model_name" name="name" value="{{$bookingtypes->bookingtype}}">
