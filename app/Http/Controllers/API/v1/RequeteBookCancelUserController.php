...
use DB;
class RequeteBookCancelUserController extends Controller
{
  ...
  public function getData(Request $request)
  {
    ...
    ->whereIn('tj_requete_book.statut',['canceled', 'rejected'])
