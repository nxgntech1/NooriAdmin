...
use DB;
class RequeteBookConfirmUserController extends Controller
{
  ...
  public function getData(Request $request)
  {
    ...
    ->select('tj_requete_book.id', 'tj_requete_book.id_user_app', 'tj_requete_book.depart_name', 'tj_requete_book.destination_name', 'tj_requete_book.latitude_depart', 'tj_requete_book.longitude_depart', 'tj_requete_book.latitude_arrivee', 'tj_requete_book.longitude_arrivee', 'tj_requete_book.number_poeple', 'tj_requete_book.place', 'tj_requete_book.statut', 'tj_requete_book.id_conducteur', 'tj_requete_book.creer', 'tj_requete_book.trajet', 'tj_user_app.nom', 'tj_user_app.prenom', 'tj_requete_book.distance', 'tj_user_app.phone', 'tj_conducteur.nom as nomConducteur', 'tj_conducteur.prenom as prenomConducteur', 'tj_conducteur.phone as driverPhone', 'tj_requete_book.heure_retour', 'tj_requete_book.statut_round', 'tj_requete_book.montant', 'tj_requete_book.duree', 'tj_requete_book.statut_paiement', 'tj_requete_book.date_book', 'tj_requete_book.nb_day', 'tj_requete_book.heure_depart', 'tj_requete_book.cu', 'tj_payment_method.libelle as payment', 'tj_payment_method.image as payment_image')
    ...
    ->where('tj_requete_book.statut','=','confirmed')
